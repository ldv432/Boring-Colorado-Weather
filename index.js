...
// const wxUrlVariables = "current=temperature_2m,weather_code,wind_speed_10m&daily=weather_code,temperature_2m_max,temperature_2m_min"
const locations = [
...
function printData(data){
  ...
  const citiesCurrents = {
    "Denver": [currentTemp, currentWind, currentWeather],
    "Colorado Springs": [currentTemp, currentWind, currentWeather],
    "Pueblo": [currentTemp, currentWind, currentWeather],
    "Fort Collins": [currentTemp, currentWind, currentWeather],
    "Grand Junction": [currentTemp, currentWind, currentWeather]
  }

  console.log(citiesCurrents)
